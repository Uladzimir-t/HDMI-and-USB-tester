...
/*
Как расчитывается напряжение (попросили объяснить)
voltage = (adcValue * V_REF) / ADC_MAX = V_REF * (adcValue / ADC_MAX)
V_REF = 3.3 //рефренсное напряжение (3.3 В);
ADC_MAX = 4095 //максимальное значение для 12-битного АЦП
voltage = 3.3 * (adcValue / 4095) = 0.033 * (adcValue / 40.95) = 0.033 * (data / 40.95)
*/
}
